...
export default function AllPreviousGames({ from1v1 = false }) {
  ...
  useEffect(() => {
    ...
    (async function () {
      try {
        const resp = await fetch(`${baseUrl}/getPreviousGameCount/${collectionMint}`);
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // console.log("gamesssdsdsd", games);
  ...
  const loadMoreData = async () => {
    ...
    try {
      ...
      setSkip(newSkip);
      const resp = await fetch(
        `${baseUrl}/getPreviousGame/${collectionMint}/${newSkip}/${
  ...
  return (
    <>
                    ...
                    <div className="table">
                      <div className="py-[1px] column hover:bg-yankees-blue hover:rounded-3xl hover:px-6 ">
                        <div className="w-[110%] table-body hover:cursor-default">
                          <Link
                            to={`/${replaceSlug(ele.User_name) || ele?.winner_pubkey}`}
                            state={{
                          ...
                          >
                            <div className="flex gap-4 cursor-pointer">
                              <div className="overflow-hidden rounded-xl ">
                                {ele.User_name && ele.Winner_image ? (
                                  <img
                                    ...
                                    className="w-10 h-10 cursor-pointer rounded-xl object-cover bg-chat-bg bg-opacity-95"
                                  />
                                ) : (
                                  <img
                                    src={`${
                              ...
                              <div className="flex items-center font-bold leading-6 cursor-pointer text-gray overflow_text overflow-ellipsis">
                                ...
                                {ele.User_name ? ele.User_name : getAddress(ele?.winner_pubkey)}
                              </div>
                            </div>
                          </Link>
                        </div>
                        ...
                        {from1v1 && (
                          <div className="m-auto table-body w-[30%] text-end cursor-default !pr-3">
                            {ele.winner_pubkey === ele.winningAllNFT[0].player_id ? (
                              <img
                                src={doge_2}
                                onError={handleImageError}
                        ...
                        <div className="m-auto w-[70%] table-body text-end cursor-default">
                          <div className="pr-5 cursor-default text-space-gray">{ele.ROI}%</div>
                        </div>
              ...
              <CSSTransition key={ele.account} timeout={500} classNames="item">
                <div className="block mt-3 lg:hidden">
                  <div className="bg-yankees-blue rounded-3xl">
                    <div className="px-8">
                      <Link
                        to={`/${replaceSlug(ele.User_name) || ele.playerPubKey}`}
                        state={{
      ...
      <InfoModal open={open} onClose={CloseModal} roundDetails={rounds[selectedIndex]}></InfoModal>
    </>
  );
}

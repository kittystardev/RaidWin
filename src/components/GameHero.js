            ...
            <div className='flex md:mt-[10px] '>
                ...
                <div className='relative flex items-center xl:hidden 2xl:hidden  mt-10 lg:mt-0 xl:mt-0 2xl:mt-0 justify-center'>
                    <div className='relative'>
                        <div className='absolute top-0 bg-image-gradient-top w-36 h-16 blur-[80px] opacity-80'>
                        </div>
                        <img src={hero2} className="relative left-[14px] bottom-[16px] " />

...
export default function ShareOption() {
  ...
  const shareOnTwitter = () => {
    const twitterShareUrl = `https://twitter.com/intent/tweet?url=${encodeURIComponent(
      window.location.href
    )}&text=${encodeURIComponent("Check out this collection on RaidWin")}`;
  ...
  return (
    ...
    >
      <Menu.Items className="absolute z-50 max-sm:-left-14  sm:right-0 mt-2 w-56 origin-top-right divide-y divide-gray-100  bg-pickled-bluewood rounded-3xl shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
        <div className="p-2">
          <Menu.Item>
            <div

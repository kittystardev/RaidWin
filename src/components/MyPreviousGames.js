...
export default function MyPreviousGames() {
  const [searchParams] = useSearchParams();
  // let { collectionMint } = useParams();
  // let { collectionMint, gameId } = useParams();
      ...
      >
        <div className="table">
          <div className="column">
            ...
            <div className="w-1/4 row table-heading">Winnings</div>
